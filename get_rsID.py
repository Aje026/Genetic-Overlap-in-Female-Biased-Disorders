...
diabetes1 = pd.read_csv('diabetes1.tsv', sep='\t')
fibromyalgia = pd.read_csv('fibromyalgia_buildGRCh38.tsv', sep='\t')
gdm = pd.read_csv('GD.tsv', sep='\t')
...
fatigue = pd.read_csv('chronic_fatigue_build_grch38.tsv', sep='\t')
