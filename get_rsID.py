...
endometriosis_updated.to_csv('endometriosis_updates2.tsv', sep='\t', index=False) """
...
preeclampsia_updated.to_csv('preeclampsia_updated2.tsv', sep='\t', index=False)
...
preterm_birth_updated.to_csv('preterm_birth_updated2.tsv', sep='\t', index=False)



""" pcos = pd.read_csv('pcos.txt', sep='\t')
pcos_updated = pd.merge(pcos, build37, on=['chr', 'pos'], how='inner')
pcos_updated.to_csv('pcos_updated2.tsv', sep='\t', index=False)  """