...
df_eqtl = pd.read_csv('FUMA_dowloads_all_tissue/eQTL/eqtl_SZC.txt', sep='\t')
df_snps = pd.read_csv('FUMA_dowloads_all_tissue/SNPs/snps_SZC.txt', sep='\t')
...
df_final.to_csv('SZC_eqtl.txt', sep="\t", header=True, index=False)